...
class MVSDataset(Dataset):
    def __init__(self, dataset_filepath, list_filepath, neighbor_view_num=20):
    ...
    def build_list(self):
        ...
        assert self.neighbor_view_num == 20
        for scene_id in scene_ids:  # fixed sample type, 1 metas per scene
            metas.append([scene_id, "000", "002", "006", "008", "012", "007", "001", "003", "004", "005", "009", "010", "011", "013", "014", "015", "016", "017", "018", "019", "020"])
        return metas
    ...
    def __getitem__(self, index):
        ...
        depth_ref = self.read_depth(os.path.join(self.dataset_filepath, scene_id, "Depths/{}.tiff".format(sample_id)))
...
class SceneData():
    def __init__(self, dataset_filepath, scene_id, sample_id="000", neighbor_view_num=20):
        ...
        assert self.sample_id == "000"
        self.neighbor_view_ids = ["001", "002", "003", "004", "005", "006", "007", "008", "009", "010", "011", "012", "013", "014", "015", "016", "017", "018", "019", "020"]
    ...
    def loadSceneData(self):
        ...
        depth_ref = self.read_depth(os.path.join(self.dataset_filepath, self.scene_id, "Depths/{}.tiff".format(self.sample_id)))
        ...
        return {
            ...
            "E_ref": E_ref,  # [1, 4, 4], torch.Tensor
...
if __name__ == '__main__':
    ...
    dataset_dirpath = r"D:\Datasets\RSSYN"
    list_filepath = "datalist/blenderSYN/train.txt"
    neighbor_view_num = 20
    dataset = MVSDataset(dataset_dirpath, list_filepath, neighbor_view_num=neighbor_view_num)
    print(len(dataset))
    sample = dataset[20]

    # sample = SceneData(dataset_dirpath, scene_id="scene_003").loadSceneData()
